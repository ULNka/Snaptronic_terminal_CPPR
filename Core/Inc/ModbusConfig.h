...
#define T35  3              // Timer T35 period (in ticks) for end frame detection.
#define MAX_BUFFER  32	    // Maximum size for the communication buffer in bytes.
#define TIMEOUT_MODBUS 300 // Timeout for master query (in ticks)
#define MAX_M_HANDLERS 3    //Maximum number of modbus handlers that can work concurrently
#define MAX_TELEGRAMS 16     //Max number of Telegrams in master queue
